...
$(".button").hover(function(){
  ...
  {
    $(this).css("backgroundImage", "url('https://github.com/scrunnchy/portfolio/tree/main/images/site_images/button_hover.svg')").removeClass("normal");
  }
  else
  {
    $(this).css("backgroundImage", "url('https://github.com/scrunnchy/portfolio/tree/main/images/site_images/button_normal.svg')").addClass("normal");
  }
});